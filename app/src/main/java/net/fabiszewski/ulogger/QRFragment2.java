...
public class QRFragment2 extends Fragment implements LoggerTask.LoggerTaskCallback, ImageTask.ImageTaskCallback {
    ...
    private static final String TAG = QRFragment2.class.getSimpleName();
    ...
    static QRFragment2 newInstance() {
        return new QRFragment2();
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View layout = inflater.inflate(R.layout.fragment_scan_barcode_from_camera, container, false);
